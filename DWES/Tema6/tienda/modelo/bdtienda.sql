...
CREATE DATABASE bdtienda DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
CREATE USER IF NOT EXISTS tienda@localhost IDENTIFIED BY 'tienda2021';
GRANT ALL ON bdtienda.* TO 'tienda'@'localhost';
use bdtienda;
-- Creamos las tablas
CREATE TABLE bdtienda.tienda (
	cod INT NOT NULL AUTO_INCREMENT,
	nombre VARCHAR(100) NOT NULL,
	tlf VARCHAR(13) NULL,
	PRIMARY KEY (cod)
) ENGINE = INNODB;
CREATE TABLE bdtienda.familia (
	cod VARCHAR(6) NOT NULL,
	nombre VARCHAR(200) NOT NULL,
	PRIMARY KEY (cod)
) ENGINE = INNODB; 
CREATE TABLE bdtienda.producto (
...
-- --------------------------------------------------------
-- usuario: dwes, password: dwes
INSERT INTO `usuarios` (`usuario`, `contrasena`) VALUES
('dwes', '$2y$10$IDGnGsz7cpfzeYahgn5yWOloydODuORmkt15H.IOYONGqcu/dOS9a');
